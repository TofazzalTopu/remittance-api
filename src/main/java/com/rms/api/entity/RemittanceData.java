...
@Entity
@NoArgsConstructor
@Table(name = "REMITTANCE_DATA_TEST")
public class RemittanceData implements Serializable {
	...
	@Id
	@Column(name = "ID")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "REMITTANCE_DATA_GEN_TEST")
	@SequenceGenerator(name = "REMITTANCE_DATA_GEN_TEST", sequenceName = "REMITTANCE_DATA_SEQ_TEST", allocationSize = 100)
	private Long id;
