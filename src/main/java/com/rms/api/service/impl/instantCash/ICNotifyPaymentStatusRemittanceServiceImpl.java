...
import com.rms.api.model.instantCash.ICConfirmDTO;
import com.rms.api.model.instantCash.ICConfirmResponseDTO;
...
import com.rms.api.service.ria.RmsApiProcessorService;
...
public class ICNotifyPaymentStatusRemittanceServiceImpl implements ICNotifyPaymentStatusRemittanceService {
    ...
    @Autowired
    private RmsApiProcessorService rmsApiProcessorService;
    ...
    public PaymentApiResponse notifyCashPaymentStatus(PaymentApiResponse paymentApiResponse, ICExchangePropertyDTO icDTO, String referenceNo) {
        Optional<ICCashRemittanceData> optionalICCashRemittanceData = icCashRemittanceDataService.findByExchangeCodeAndReferenceNoAndProcessStatus(icDTO.getExchangeCode(), referenceNo, 0, RemittanceData.OPEN);
    ...
    public PaymentApiResponse notifyStatus(PaymentApiResponse paymentApiResponse, ICExchangePropertyDTO icDTO, ICCashRemittanceData icCashRemittanceData, String referenceNo) {
        ...
        try {
            ...
            icCashRemittanceData.setProcessStatus(RemittanceData.COMPLETED);
    ...
    public RemittanceData saveRemittanceData(ICCashRemittanceData icCashRemittanceData, String exchangeCode) {
        ...
        remittanceData = rmsApiProcessorService.saveWebOrSpotData(remittanceData, exchangeCode, Constants.EXCHANGE_HOUSE_INSTANT_CASH, 0, 1, INSTANT_CASH_API_USER_ID);
