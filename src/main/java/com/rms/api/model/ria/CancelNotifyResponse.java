...
public class CancelNotifyResponse implements Serializable {
	...
	public String toString() {
		return "CancelNotifyResponse [processDate=" + processDate + ", processTime=" + processTime
				+ ", notificationCode=" + notificationCode + ", notificationDesc=" + notificationDesc + ", pcOrderNo="
				+ pcOrderNo + ", scOrderNo=" + scOrderNo + ", comments=" + comments + "]";
	}
}
